...
func (c *grpcClient) Get(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/Grpc/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *grpcClient) Delete(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedGrpcServer) Delete(context.Context, *Request) (*Response, error) {
...
func _Grpc_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpcServer).Delete(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
